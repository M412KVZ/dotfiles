...
#polybar ip -c ~/.config/polybar/minimal_bar.ini &
#polybar hack -c ~/.config/polybar/minimal_bar.ini &
...
polybar brightnessctl -c ~/.config/polybar/minimal_bar.ini &
polybar mpd -c ~/.config/polybar/minimal_bar.ini &
